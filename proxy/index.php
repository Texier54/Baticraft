...
else
{
  ...
  <div style="text-align: center"><input type="submit" name="browse" value="Acceder" onclick="return submit_form();" /></div>
  <div style="text-align: center"><?php echo $PHProxy->version ?> &copy;<a href="http://www.baticraft.tk/">Baticraft</a>
</div>
  </form>
  <?php
}
